...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            /* CRITICAL FIX: Robust visibility handling */
            .hidden-form {
        ...
        <div class="w-full max-w-6xl flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
            ...
            @if (session('success'))
                <div x-data="{ show: true }"
                     ...
                     class="fixed top-5 right-5 z-50 bg-green-100 border-l-4 border-green-500 text-green-700 p-4 rounded shadow-lg flex items-center gap-3">
            ...
            <div class="flex-1 max-w-md w-full">
                <div class="bg-white rounded-2xl shadow-xl p-8 relative min-h-[500px]">
                    <div class="flex gap-2 mb-6">
                        <button id="signin-tab" class="flex-1 py-3 text-sm font-semibold rounded-xl transition-all duration-200 bg-white text-[#1b1b18] border-2 border-black shadow-sm">Sign In</button>
                        <button id="signup-tab" class="flex-1 py-3 text-sm font-semibold rounded-xl transition-all duration-200 text-[#706f6c] border-2 border-gray-200 hover:border-gray-300">Sign Up</button>
                    </div>
                        ...
                        <div class="relative">
                            ...
                            <div class="relative">
                                ...
                                <button type="button" onclick="togglePassword('signin-password', 'eyeIconSignIn')" 
                                    class="absolute inset-y-0 right-0 flex items-center px-3 text-gray-400 hover:text-[#FB7E00] focus:outline-none">
                        ...
                        <div class="relative">
                            ...
                            <div class="relative">
                                ...
                                <button type="button" onclick="togglePassword('signup-password', 'eyeIconSignUp')" 
                                    class="absolute inset-y-0 right-0 flex items-center px-3 text-gray-400 hover:text-[#9FC089] focus:outline-none">
    ...
    <script type="module">
        ...
        // FIX 1: Better session login with timeout and retry
        window.handleSessionLogin = async (user) => {
            try {
                ...
                if (!response.ok) {
                    ...
                    throw new Error(data.message || 'Session login failed');
                }
        ...
        // FIX 2: Use redirect instead of popup for Google Sign-In (more reliable)
        window.handleGoogleSignIn = async () => {
            ...
            try {
                ...
                // FIX: Try popup first, fallback to redirect
                try {
        ...
        // FIX 3: Handle redirect result on page load
